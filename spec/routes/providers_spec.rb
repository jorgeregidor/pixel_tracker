...
RSpec.describe ProvidersController, type: :routing do
  describe "routes ProvidersController" do

    it "routes to #index" do
      expect(:get => "/").to route_to("providers#index")
    end

    it "routes to #index" do
      expect(:get => "/providers").not_to be_routable
    end

    it "routes to #show" do
      expect(:get => "providers/1").not_to route_to("providers#show")
    end
